...
6、yarn add html-webpack-plugin@2.30.1 --dev（html加载器）1

7、yarn add babel-core@6.26.0 babel-preset-env@1.6.1 babel-loader@7.1.2 --dev（es6转换es5）1

8、yarn add babel-preset-react@6.24.1 --dev（依赖react）1

9、yarn add react react-dom（安装react）1

10、yarn add style-loader css-loader --dev（提取样式）1

11、yarn add extract-text-webpack-plugin@3.0.2 --dev（把样式提取到一个单独文件）1

	npm install --save-dev extract-text-webpack-plugin

12、yarn add sass-loader@6.0.6 node-sass@4.7.2 --dev（安装sass-loader）（打包sass出错时重建命令npm rebuild node-sass）1

13、yarn add file-loader@1.1.6 url-loader@0.6.2 --dev(安装文件、图片配置)1

14、yarn add webpack-dev-server@2.9.7 --dev（安装devServer）1
